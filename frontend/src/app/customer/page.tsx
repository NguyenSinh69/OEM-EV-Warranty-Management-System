...
export default function CustomerDashboardPage() {
  ...
  const {
    ...
    error: vErr,
    isLoading: vLoad,
  } = useSWR(vehiclesKey, fetcher, { revalidateOnFocus: false });

  const {
    data: cRaw,
    error: cErr,
    isLoading: cLoad,
  } = useSWR(claimsKey, fetcher, { revalidateOnFocus: false });
